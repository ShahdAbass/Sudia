    ...
    [2873], {
        72873: function(e, t, s) {
            ...
            function m({
                ...
                let v, w, b, S, E;
                i.includes("thumbs") && s.thumbs && s.thumbs.swiper && p.thumbs && !p.thumbs.swiper && (v = !0), i.includes("controller") && s.controller && s.controller.control && p.controller && !p.controller.control && (w = !0), i.includes("pagination") && s.pagination && (s.pagination.el || d) && (p.pagination || !1 === p.pagination) && u && !u.el && (b = !0), i.includes("scrollbar") && s.scrollbar && (s.scrollbar.el || o) && (p.scrollbar || !1 === p.scrollbar) && h && !h.el && (S = !0), i.includes("navigation") && s.navigation && (s.navigation.prevEl || l) && (s.navigation.nextEl || n) && (p.navigation || !1 === p.navigation) && f && !f.prevEl && !f.nextEl && (E = !0);
                if (c.forEach((t => {
                        if (r(p[t]) && r(s[t])) a(p[t], s[t]);
                        else {
                            const n = s[t];
                            !0 !== n && !1 !== n || "navigation" !== t && "pagination" !== t && "scrollbar" !== t ? p[t] = s[t] : !1 === n && e[i = t] && (e[i].destroy(), "navigation" === i ? (p[i].prevEl = void 0, p[i].nextEl = void 0, e[i].prevEl = void 0, e[i].nextEl = void 0) : (p[i].el = void 0, e[i].el = void 0))
                        }
                        var i
                    })), i.includes("children") && m && p.virtual.enabled ? (m.slides = t, m.update(!0)) : i.includes("children") && e.lazy && e.params.lazy.enabled && e.lazy.load(), v) {
                    g.init() && g.update(!0)
                }
                w && (e.controller.control = p.controller.control), b && (d && (p.pagination.el = d), u.init(), u.render(), u.update()), S && (o && (p.scrollbar.el = o), h.init(), h.updateSize(), h.setTranslate()), E && (n && (p.navigation.nextEl = n), l && (p.navigation.prevEl = l), f.init(), f.update()), i.includes("allowSlideNext") && (e.allowSlideNext = s.allowSlideNext), i.includes("allowSlidePrev") && (e.allowSlidePrev = s.allowSlidePrev), i.includes("direction") && e.changeDirection(s.direction, !1), e.update()
            }
            ...
            const w = (0, i.forwardRef)((({
                ...
                let E = !1;
                const [T, y] = (0, i.useState)("swiper"), [C, x] = (0, i.useState)(null), [P, k] = (0, i.useState)(!1), M = (0, i.useRef)(!1), O = (0, i.useRef)(null), L = (0, i.useRef)(null), $ = (0, i.useRef)(null), _ = (0, i.useRef)(null), z = (0, i.useRef)(null), A = (0, i.useRef)(null), I = (0, i.useRef)(null), N = (0, i.useRef)(null), {
                    params: D,
                    passedParams: G,
                    rest: B,
                    events: j
                ...
                if (Object.assign(D.on, {
                        _containerClasses(e, t) {
                            y(t)
                        }
                    }), !O.current && (Object.assign(D.on, j), E = !0, L.current = function(e) {
                        return new n.ZP(e)
                    }(D), L.current.loopCreate = () => {}, L.current.loopDestroy = () => {}, D.loop && (L.current.loopedSlides = u(V, D)), L.current.virtual && L.current.params.virtual.enabled)) {
                    L.current.virtual.slides = V;
                    const e = {
                        cache: !1,
                        slides: V,
                        renderExternal: x,
                ...
                L.current && L.current.on("_beforeBreakpoint", R);
                return (0, i.useEffect)((() => () => {
                    L.current && L.current.off("_beforeBreakpoint", R)
                })), (0, i.useEffect)((() => {
                    !M.current && L.current && (L.current.emitSlidesClasses(), M.current = !0)
                })), g((() => {
                    if (S && (S.current = O.current), O.current) return function({
                        el: e,
                        nextEl: t,
                        prevEl: s,
                        paginationEl: i,
                        ...
                        l(a) && t && s && (r.params.navigation.nextEl = t, r.originalParams.navigation.nextEl = t, r.params.navigation.prevEl = s, r.originalParams.navigation.prevEl = s), o(a) && i && (r.params.pagination.el = i, r.originalParams.pagination.el = i), d(a) && n && (r.params.scrollbar.el = n, r.originalParams.scrollbar.el = n), r.init(e)
                    }({
                        el: O.current,
                        nextEl: z.current,
                        prevEl: A.current,
                    ...
                    !E && j && L.current && Object.keys(j).forEach((e => {
                        L.current.on(e, j[e])
                    }));
                    ...
                    }(G, $.current, V, _.current);
                    return $.current = G, _.current = V, e.length && L.current && !L.current.destroyed && m({
                        swiper: L.current,
                        slides: V,
                        passedParams: G,
                        changedParams: e,
                ...
                }), [C]), i.createElement(t, v({
                    ref: O,
                    className: c(`${T}${e?` ${e}`:""}`)
                }, B), H["container-start"], l(D) && i.createElement(i.Fragment, null, i.createElement("div", {
                    ref: A,
                ...
                }), o(D) && i.createElement("div", {
                    ref: I,
                    className: "swiper-pagination"
                }), i.createElement(s, {
                    className: "swiper-wrapper"
                }, H["wrapper-start"], D.virtual ? function(e, t, s) {
                    if (!s) return null;
                ...
                }(L.current, V, C) : !D.loop || L.current && L.current.destroyed ? V.map((e => i.cloneElement(e, {
                    swiper: L.current
                }))) : function(e, t, s) {
                ...
                }(L.current, V, D), H["wrapper-end"]), H["container-end"])
            }));
        ...
        965: function(e, t, s) {
                ...
                for (let n = 1; n < e.length; n += 1) {
                    ...
                    if (void 0 !== r && null !== r && (i = r, !("undefined" !== typeof window && "undefined" !== typeof window.HTMLElement ? i instanceof HTMLElement : i && (1 === i.nodeType || 11 === i.nodeType)))) {
                        ...
                        for (let s = 0, i = e.length; s < i; s += 1) {
                            ...
                            void 0 !== n && n.enumerable && (S(t[i]) && S(r[i]) ? r[i].__swiper__ ? t[i] = r[i] : E(t[i], r[i]) : !S(t[i]) && S(r[i]) ? (t[i] = {}, r[i].__swiper__ ? t[i] = r[i] : E(t[i], r[i])) : t[i] = r[i])
                        }
                    }
                }
                var i;
            ...
            var $ = {
                ...
                updateSlides: function() {
                    ...
                    for (let T = 0; T < p; T += 1) {
                        x = 0;
                        const n = c.eq(T);
                        if (C && e.grid.updateSlide(T, n, p, t), "none" !== n.css("display")) {
                            ...
                            } else x = (r - (i.slidesPerView - 1) * b) / i.slidesPerView, i.roundLengths && (x = Math.floor(x)), c[T] && (c[T].style[t("width")] = `${x}px`);
                            c[T] && (c[T].swiperSlideSize = x), h.push(x), i.centeredSlides ? (S = S + x / 2 + E / 2 + b, 0 === E && 0 !== T && (S = S - r / 2 - b), 0 === T && (S = S - r / 2 - b), Math.abs(S) < .001 && (S = 0), i.roundLengths && (S = Math.floor(S)), y % i.slidesPerGroup === 0 && u.push(S), f.push(S)) : (i.roundLengths && (S = Math.floor(S)), (y - Math.min(e.params.slidesPerGroupSkip, y)) % e.params.slidesPerGroup === 0 && u.push(S), f.push(S), S = S + x + b), e.virtualSize += x + b, E = x, y += 1
                        }
                    }
                    ...
                    p !== d && e.emit("slidesLengthChange"), u.length !== v && (e.params.watchOverflow && e.checkOverflow(), e.emit("snapGridLengthChange")), f.length !== w && e.emit("slidesGridLengthChange"), i.watchSlidesProgress && e.updateSlidesOffset()
                },
            ...
            var W = {
                attachEvents: function() {
                    ...
                    e.onTouchStart = N.bind(e), e.onTouchMove = D.bind(e), e.onTouchEnd = G.bind(e), s.cssMode && (e.onScroll = V.bind(e)), e.onClick = j.bind(e), i.touch && !H && (t.addEventListener("touchstart", R), H = !0), F(e, "on")
                },
            ...
            class Q {
                constructor(...e) {
                    let t, s;
                    if (1 === e.length && e[0].constructor && "Object" === Object.prototype.toString.call(e[0]).slice(8, -1) ? s = e[0] : [t, s] = e, s || (s = {}), s = E({}, s), t && !s.el && (s.el = t), s.el && g(s.el).length > 1) {
                        const e = [];
                    ...
                    const i = this;
                    i.__swiper__ = !0, i.support = k(), i.device = M({
                    ...
                    const r = E({}, U, n);
                    return i.params = E({}, r, J, s), i.originalParams = E({}, i.params), i.passedParams = E({}, s), i.params && i.params.on && Object.keys(i.params.on).forEach((e => {
            ...
            function te({
                ...
                function c() {
                    ...
                    const s = n(t.nextEl),
                        i = n(t.prevEl);
                    s && s.length > 0 && s.on("click", d), i && i.length > 0 && i.on("click", o), Object.assign(e.navigation, {
                        $nextEl: s,
                        nextEl: s && s[0],
                        $prevEl: i,
                        prevEl: i && i[0]
